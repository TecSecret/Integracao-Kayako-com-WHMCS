		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
			<tr>
				<td valign="top">
					...
					<div class="kbinfo">{$LANG.integrakayakopostedby} {$_knowledgebaseArticle.author} on {$_knowledgebaseArticle.date}</div>
				</td>
			</tr>
			...
			<br /><br />
			<div><table class="hlineheader hlinegray"><tr><th rowspan="2" nowrap>{$LANG.integrakayakoattachments}</th><td>&nbsp;</td></tr><tr><td class="hlinelower">&nbsp;</td></tr></table></div>
