...
<div style="text-align: center;">{$LANG.integrakayakonopermission}</div>
<br/><br/>
{else}
...
<div class="boxcontainerlabel" style="min-height: 30px;">
	<div style="float: right">{if $_canChangeTicketProperties != false}
		<div class="headerbutton" onclick="javascript: $('#ticketpropertiesform').submit();">{$LANG.integrakayakoupdate}</div>
		{/if}
		...
		<tr>
			<td>
				<div class="ticketgeneralcontainer">
					...
					<div class="ticketgeneralinfocontainer">{$LANG.integrakayakocreated} {$_ticketContainer.dateline}&nbsp;&nbsp;&nbsp;&nbsp;{$LANG.integrakayakoupdated} {$_ticketContainer.lastactivity}</div>
				...
				<div class="ticketgeneralcontainer">
					<div style="background-color: {$_ticketContainer.statusbgcolor};" class="ticketgeneralproperties">
						...
						<div class="ticketgeneralpropertiesobject">
							<div class="ticketgeneralpropertiestitle">{$LANG.integrakayakodepartament}</div>
						...
						<div class="ticketgeneralpropertiesobject">
							<div class="ticketgeneralpropertiestitle">{$LANG.integrakayakoowner}</div>
							<div class="ticketgeneralpropertiescontent">{if $_ticketContainer.owner==''}{$LANG.integrakayakounassigned} {else} {$_ticketContainer.owner}{/if}</div>
						</div>

						<div class="ticketgeneralpropertiesdivider"><img border="0" align="middle" src="{$_imageURL}/ticketpropertiesdivider.png"></div>

						<div class="ticketgeneralpropertiesobject">
							<div class="ticketgeneralpropertiestitle">{$LANG.integrakayakotype2}</div>
						...
						<div class="ticketgeneralpropertiesobject">
							<div class="ticketgeneralpropertiestitle">{$LANG.integrakayakostatus2}</div>
						...
						<div class="ticketgeneralpropertiesobject" style="background-color: {$_ticketContainer.prioritybgcolor};">
							<div class="ticketgeneralpropertiestitle">{$LANG.integrakayakopriority2}</div>
	...
	<form method="post" action="{$_submitURL}?action=reply&ticketid={$_ticketContainer.ticketid}" name="TicketReplyForm" enctype="multipart/form-data">
		<div class="ticketpaddingcontainer">
			<table class="hlineheader">
				<tr>
					<th rowspan="2" nowrap>{$LANG.integrakayakomessagedetails}</th>
					<td>&nbsp;</td>
				</tr>
				<tr>
			...
			<table class="hlineheader">
				<tr>
					<th rowspan="2" nowrap>{$LANG.integrakayakouploadfile}
