...
<div class="boxcontainer">
	<div class="boxcontainerlabel">{if $_settings.nw_enablerss == '1'}<div style="float: right;"><a href="{$_swiftPath}rss/index.php?/News/Feed" title="{$_language.rssfeed}" target="_blank"><img src="{$_themePath}images/icon_rss.png" align="absmiddle" alt="{$_language.rssfeed}" border="0" /></a></div>{/if}{$LANG.integrakayakonews}</div>
